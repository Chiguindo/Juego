...
function preload(){
 ...
 poderImg = loadAnimation ("Personajes jugables/balas0.png","Personajes jugables/balas1.png","Personajes jugables/balas2.png","Personajes jugables/balas3.png","Personajes jugables/balas4.png")
...
function draw() {
  ...
  if (keyDown("DOWN_ARROW")){
    ...
    if (keyWentDown("SPACE")){
      ...
      poder = createSprite (displayWidth-1150, heroe.y-10, 20,10 );
      poder.velocityX = 5;
      poder.addAnimation ("shoot",poderImg);
      poder.scale = +3;
